#!/bin/bash
	# S
	/home/dan/inst/OpenSCAD-2022.11.27.ai12865-x86_64.AppImage -o S/preview.stl -o S.echo parametric-3d-rotator.scad -D PartNumber="-1" -D RotatorMountingPointsPitch=200 -D TransferRatio=3 -D FirstHeight=15 -D CircularPitch=230 -D BoxThickness=3 -D AntMountScrewDiameter=6 -D AntWheelHeight=15 -D AntMountScrewHead=10.2
	/home/dan/inst/OpenSCAD-2022.11.27.ai12865-x86_64.AppImage -o S.DXF parametric-3d-rotator.scad -D PartNumber="0" -D RotatorMountingPointsPitch=200 -D TransferRatio=3 -D FirstHeight=15 -D CircularPitch=230 -D BoxThickness=3 -D DXFexport=1 -D AntMountScrewDiameter=6 -D AntWheelHeight=15 -D AntMountScrewHead=10.2
	/home/dan/inst/OpenSCAD-2022.11.27.ai12865-x86_64.AppImage -o Sout.DXF parametric-3d-rotator.scad -D PartNumber="13" -D RotatorMountingPointsPitch=200 -D TransferRatio=3 -D FirstHeight=15 -D CircularPitch=230 -D BoxThickness=3 -D DXFexport=1 -D AntMountScrewDiameter=6 -D AntWheelHeight=15 -D AntMountScrewHead=10.2
	# M
...
do
	...
	# S
	/home/dan/inst/OpenSCAD-2022.11.27.ai12865-x86_64.AppImage -o S/$i.stl parametric-3d-rotator.scad -D PartNumber="$i" -D RotatorMountingPointsPitch=200 -D TransferRatio=3 -D FirstHeight=15 -D CircularPitch=230 -D BoxThickness=3 -D AntMountScrewDiameter=6 -D AntWheelHeight=15 -D AntMountScrewHead=10.2
	# M
